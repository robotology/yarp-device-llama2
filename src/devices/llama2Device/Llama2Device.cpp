...
bool Llama2Device::ask(const std::string &question, yarp::dev::LLM_Message &oAnswer)
{
    ...
    int n_predict = 10;
    std::string answer = "";
    std::string final_output;   //used to store the complete answer generated by the model
    ...
    for(auto id: prompt_tokens){
        ...
        //std::cout << s << " ";  // Stampa il token senza andare a capo
        //std::cout.flush();       // Svuota il buffer per visualizzare subito il token

        final_output += std::string(buf, n);
    }
    //std::cout << std::endl;      // Andare a capo dopo aver stampato tutti i token
    ...
    for (int n_pos = 0; n_pos + batch.n_tokens < n_prompt + n_predict;) {
        ...
        // sample the next token
        {
            ...
            final_output += std::string(buf, n); // Accumula il token
            ...
            int bar_width = 50;  // Lunghezza della barra di avanzamento
            ...
            // Stampa la barra di avanzamento usando yCInfo
            yCInfo(LLAMA2DEVICE) << progress_bar;
        }
    }

    //std::cout << std::endl; // Vai a capo alla fine della generazione
