...
* | -          | npredict       | int    | -     | 64            | 0        | number of tokens generated by the model                                    | Here are additional notes |
* | -          | progress_bar   | bool   | -     | 0             | 0        | print generation progress bar(0 = no progress bar, 1 = print progress bar) | Here are additional notes |
* | -          | ngl            | int    | -     | 30            | 0        | number of layers to offload to the gpu                                     | Here are additional notes |
*
* The device can be launched by yarpdev using one of the following examples (with and without all optional parameters):
* \code{.unparsed}
* yarpdev --device yarp_llama2Device --model_context <optional_value> --model_name <mandatory_value> --npredict 64 --progress_bar 0 --ngl 30
* \endcode
*
* \code{.unparsed}
