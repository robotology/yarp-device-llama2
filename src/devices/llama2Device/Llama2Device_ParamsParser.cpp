...
// Generated on: Fri Jan 10 11:55:07 2025
...
std::string      Llama2Device_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + std::string("'progress_bar': print generation progress bar(0 = no progress bar, 1 = print progress bar)\n");
    doc = doc + std::string("'ngl': number of layers to offload to the gpu\n");
    doc = doc + std::string("\n");
    doc = doc + std::string("Here are some examples of invocation command with yarpdev, with all params:\n");
    doc = doc + " yarpdev --device yarp_llama2Device --model_context <optional_value> --model_name <mandatory_value> --npredict 64 --progress_bar 0 --ngl 30\n";
