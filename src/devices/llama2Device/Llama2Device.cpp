...
bool Llama2Device::open(yarp::os::Searchable &config)
{
    ...
    //yCInfo(LLAMA2DEVICE) << model_path;
    //model_path = "/home/leonardo/Repos/yarp-device-llama2/models/contexts/llama2/speechless-llama2-13b.Q4_K_M.gguf";
...
bool Llama2Device::ask(const std::string &question, yarp::dev::LLM_Message &oAnswer)
{
    ...
    std::string final_output;   // variable used to store the complete answer generated by the model
    prompt = question;
...
bool Llama2Device::setPrompt(const std::string &prompt_add){
    if(prompt_set == true){
        yCInfo(LLAMA2DEVICE)<< "Prompt already set!";
        return true;
    }
    prompt_set = true;
...
bool Llama2Device::getConversation()
{
    yCInfo(LLAMA2DEVICE) << conversation;
